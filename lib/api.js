...
class ApiClient {
  ...
  async verifyPayment(appointmentId, razorpayOrderId, razorpayPaymentId, razorpaySignature) {
  ...
  async getBookedSlotsByDoctor(doctorId) {
    return this.request(`/appointments?doctorId=${doctorId}`);
  }

  // Get all reviews for a specific doctor
  async getDoctorReviews(doctorId) {
    return this.request(`/appointments/doctor/${doctorId}/reviews`);
  }
}
